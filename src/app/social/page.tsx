              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                <div className="relative group">
                  <button
                    ...
                    className="relative bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 text-sm font-medium shadow-lg hover:shadow-blue-500/25 transform hover:scale-105 w-full sm:w-auto"
                  >
                  ...
                  {pendingRequests.length > 0 && (
                    <div className="absolute -top-2 -right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center animate-pulse shadow-lg">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 text-sm font-medium shadow-lg hover:shadow-green-500/25 transform hover:scale-105 w-full sm:w-auto"
                >
                  <div className="w-4 h-4 sm:w-5 sm:h-5 bg-white/20 rounded-full flex items-center justify-center">
                    <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isLoading ? (
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden">
              {/* Enhanced Leaderboard Header - Mobile Responsive */}
              <div className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 backdrop-blur-sm p-4 sm:p-6 border-b border-white/10">
                {/* Desktop Header */}
                ...
                <div className="sm:hidden text-center">
                  ...
                  <p className="text-sm text-gray-400 mt-1">Tap on a friend to see actions</p>
                </div>
              </div>

              {/* Enhanced Friends List - Mobile Responsive */}
              <div className="divide-y divide-white/10 max-h-[600px] overflow-y-auto">
                {friends.map((friend, index) => (
                  <div key={friend.id} className="group hover:bg-white/5 transition-all duration-300 hover:scale-[1.02]">
                    {/* Desktop Layout */}
                    <div className="hidden sm:grid grid-cols-12 gap-4 p-6">
                      {/* Rank */}
                    ...
                    <div className="sm:hidden p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <div className={`w-10 h-10 rounded-full bg-gradient-to-r ${getUserColor(friend.username)} flex items-center justify-center text-white font-bold text-lg shadow-lg`}>
                            {friend.username.charAt(0).toUpperCase()}
                          </div>
                          <div className="min-w-0 flex-1">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white py-2 px-3 rounded-xl transition-all duration-200 font-medium text-sm hover:shadow-lg hover:shadow-green-500/25 transform hover:scale-105"
                        >
                        ...
                        <button
                          onClick={() => handleRemoveFriend(friend.id, friend.username)}
                          className="flex-1 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-500 hover:to-pink-500 text-white py-2 px-3 rounded-xl transition-all duration-200 font-medium text-sm hover:shadow-lg hover:shadow-red-500/25 transform hover:scale-105"
                        >
                          <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                          </svg>
