  ...
  return (
    <nav className="bg-gray-900">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        {/* Mobile Tab Bar - TEST VERSION WITH DEBUGGING */}
        {status === 'authenticated' && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700 fixed bottom-0 left-0 right-0 z-[9999]" style={{ pointerEvents: 'auto' }}>
            <div className="flex items-center justify-around py-3" style={{ pointerEvents: 'auto' }}>
              <button
                onClick={() => {
                  console.log('HOME CLICKED')
                  window.location.href = '/'
                }}
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-red-500"
              ...
              <button
                ...
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-blue-500"
                style={{ pointerEvents: 'auto', minHeight: '60px' }}
              >
              ...
              <button
                ...
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-green-500"
                style={{ pointerEvents: 'auto', minHeight: '60px' }}
              >
              ...
              <button
                ...
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-yellow-500"
                style={{ pointerEvents: 'auto', minHeight: '60px' }}
              >
              ...
              <button
                ...
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-purple-500"
                style={{ pointerEvents: 'auto', minHeight: '60px' }}
              >
              ...
              <button
                ...
                className="flex flex-col items-center py-2 px-2 rounded-lg w-full text-gray-400 hover:text-white bg-pink-500"
                style={{ pointerEvents: 'auto', minHeight: '60px' }}
              >
