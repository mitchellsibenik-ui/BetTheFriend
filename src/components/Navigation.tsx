  ...
  return (
    <nav className="bg-gray-900">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        {status === 'authenticated' && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700 fixed bottom-0 left-0 right-0 z-[9999] pointer-events-auto" style={{ touchAction: 'manipulation' }}>
            <div className="flex items-center justify-around py-2" style={{ minHeight: '60px', touchAction: 'manipulation' }}>
              <Link
                href="/"
                className={`flex flex-col items-center py-2 px-3 rounded-lg transition-colors duration-200 pointer-events-auto ${
                  pathname === '/'
              ...
              <Link
                ...
                onClick={() => console.log('Sports tab clicked')}
              >
                <svg className="h-5 w-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
