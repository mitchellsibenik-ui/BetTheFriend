  ...
  return (
    <nav className="bg-gray-900">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        {/* Mobile Tab Bar - Pure HTML/JS - No Next.js */}
        {status === 'authenticated' && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700 fixed bottom-0 left-0 right-0 z-50">
            <div className="flex items-center justify-around py-3">
              <button
                className={`flex flex-col items-center py-2 px-3 rounded-lg transition-colors w-full ${
                  pathname === '/'
              ...
              <button
                className={`flex flex-col items-center py-2 px-3 rounded-lg transition-colors w-full relative ${
